import { getAll, remove } from "../../../api/catePost";
import Nav from "../../../components/nav";
import { reRender } from "../../../utils/rerender";

const AdminCatePostPage = {
    async render() {
                    ...
                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                        <div class="lg:flex lg:items-center lg:justify-between">
                            ...
                            <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">
                                Quản lý Danh mục bài viết
                            </h2>
                            </div>
                            <div class="mt-5 flex lg:mt-0 lg:ml-4">
                            <a href="/#/admin/catePosts/add" class="sm:ml-3">
                                <button type="button"
                                                    ...
                                                    <tbody class="bg-white divide-y divide-gray-200">
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                            ...
                                                            <a href="/#/admin/catePosts/edit/${post.id}" class=" bg-indigo-900 text-white p-3 rounded  hover:text-white-900">Edit</a>
                                                            </button>
            ...
            btn.addEventListener("click", () => {
                ...
                if (confirm) {
                    remove(id).then(() => {
                        ...
                        reRender(AdminCatePostPage, "#app");
                    });
                }
            });
        });
...
export default AdminCatePostPage;