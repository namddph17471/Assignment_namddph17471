                ...
                <header class="bg-white shadow">
                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                        <div class="lg:flex lg:items-center lg:justify-between">
                            ...
                            <a href="/#/admin/cateProducts/add" class="sm:ml-3">
                                <button type="button"
                                                    ...
                                                    <tbody class="bg-white divide-y divide-gray-200">
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                            ...
                                                            <a href="/#/admin/cateProducts/edit/${post.id}" class=" bg-indigo-900 text-white p-3 rounded  hover:text-white-900">Edit</a>
                                                            </button>
            ...
            btn.addEventListener("click", () => {
                ...
                if (confirm) {
                    remove(id).then(() => {
                        ...
                        reRender(AdminCateProductPage, "#app");
                    });
                }
            });
        });
...
export default AdminCateProductPage;